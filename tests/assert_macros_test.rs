...
#[test]
fn macro_assert_nearly_eq_slice_f32() {
...
#[test]
fn macro_assert_nearly_eq_slice_f64() {
...
#[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`
 ...
 right: `[1.0000008, 1.0, 1.0]`,
   eps: `7e-7`,
  ulps: `6`"#)]
fn macro_assert_nearly_eq_slice_panic_f32() {
    let array_a: [f32; 5] = [1.0, 1.0, 1.0, 1.0000008, 1.0];
    let array_b: [f32; 5] = [1.0, 1.0000008, 1.0, 1.0, 1.0];
...
#[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`
 ...
 right: `[1.0000000000000016, 1.0, 1.0]`,
   eps: `1e-15`,
  ulps: `6`"#)]
fn macro_assert_nearly_eq_slice_panic_f64() {
    let array_a: [f64; 5] = [1.0, 1.0, 1.0, 1.0000000000000016, 1.0];
    let array_b: [f64; 5] = [1.0, 1.0000000000000016, 1.0, 1.0, 1.0];
...
#[test]
fn macro_assert_nearly_ne_slice_f32() {
    let array_a: [f32; 5] = [1.0, 1.0, 1.0, 1.0000008, 1.0];
    let array_b: [f32; 5] = [1.0, 1.0000008, 1.0, 1.0, 1.0];
...
#[test]
fn macro_assert_nearly_ne_slice_f64() {
    let array_a: [f64; 5] = [1.0, 1.0, 1.0, 1.0000000000000016, 1.0];
    let array_b: [f64; 5] = [1.0, 1.0000000000000016, 1.0, 1.0, 1.0];
...
#[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`
 ...
 right: `[1.0000008, 1.0, 1.0]`,
   eps: `9e-7`,
  ulps: `7`"#)]
fn macro_assert_nearly_ne_slice_panic_f32() {
    let array_a: [f32; 5] = [1.0, 1.0, 1.0, 1.0000008, 1.0];
    let array_b: [f32; 5] = [1.0, 1.0000008, 1.0, 1.0, 1.0];
...
#[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`
 ...
 right: `[1.0000000000000016, 1.0, 1.0]`,
   eps: `2e-15`,
  ulps: `7`"#)]
fn macro_assert_nearly_ne_slice_panic_f64() {
    let array_a: [f64; 5] = [1.0, 1.0, 1.0, 1.0000000000000016, 1.0];
    let array_b: [f64; 5] = [1.0, 1.0000000000000016, 1.0, 1.0, 1.0];
