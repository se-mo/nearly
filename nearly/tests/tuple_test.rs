...
macro_rules! impl_test_f32 {
    ($( $type: ident )+, $size: tt) => {
        paste! {
            ...
            #[test]
            fn [<macro_nearly_eq_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_nearly_ne_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_nearly_op_eq_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_nearly_op_ne_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_assert_nearly_eq_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_assert_nearly_ne_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            fn [<macro_assert_nearly_eq_tuple $size _panic_f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            fn [<macro_assert_nearly_ne_tuple $size _panic_f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_debug_assert_nearly_ne_tuple $size _f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_debug_assert_nearly_eq_tuple $size _panic_f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_debug_assert_nearly_ne_tuple $size _panic_f32>]() {
                let a: ($($type,)+) = get_value!(f32, "a", $size);
                let b: ($($type,)+) = get_value!(f32, "b", $size);
                assert_ne!(a, b);
...
macro_rules! impl_test_f64 {
    ($( $type: ident )+, $size: tt) => {
        paste! {
            ...
            #[test]
            fn [<macro_nearly_eq_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_nearly_ne_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_nearly_op_eq_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_nearly_op_ne_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_assert_nearly_eq_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_assert_nearly_ne_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_assert_nearly_eq_tuple $size _panic_f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_assert_nearly_ne_tuple $size _panic_f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[test]
            fn [<macro_debug_assert_nearly_ne_tuple $size _f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_debug_assert_nearly_eq_tuple $size _panic_f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_debug_assert_nearly_ne_tuple $size _panic_f64>]() {
                let a: ($($type,)+) = get_value!(f64, "a", $size);
                let b: ($($type,)+) = get_value!(f64, "b", $size);
                assert_ne!(a, b);
