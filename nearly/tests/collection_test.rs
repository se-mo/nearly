...
macro_rules! impl_test_f32 {
    ($lhs: ty, $rhs: ty, $name_lhs: expr, $name_rhs: expr) => {
        paste! {
            ...
            #[test]
            fn [<macro_nearly_op_eq_ $name_lhs _ $name_rhs _f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            fn [<macro_nearly_op_ne_ $name_lhs _ $name_rhs _f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            fn [<macro_assert_nearly_op_eq_ $name_lhs _ $name_rhs _f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            fn [<macro_assert_nearly_op_ne_ $name_lhs _ $name_rhs _f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_assert_nearly_op_eq_ $name_lhs _ $name_rhs _panic_f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_assert_nearly_op_ne_ $name_lhs _ $name_rhs _panic_f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            fn [<macro_debug_assert_nearly_op_eq_ $name_lhs _ $name_rhs _f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[test]
            fn [<macro_debug_assert_nearly_op_ne_ $name_lhs _ $name_rhs _f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_debug_assert_nearly_op_eq_ $name_lhs _ $name_rhs _panic_f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_debug_assert_nearly_op_ne_ $name_lhs _ $name_rhs _panic_f32>]() {
                let a: $lhs = get_value!($name_lhs, "a", f32);
                let b: $rhs = get_value!($name_rhs, "b", f32);
...
macro_rules! impl_test_f64 {
    ($lhs: ty, $rhs: ty, $name_lhs: expr, $name_rhs: expr) => {
        paste! {
            ...
            #[test]
            fn [<macro_nearly_op_eq_ $name_lhs _ $name_rhs _f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            fn [<macro_nearly_op_ne_ $name_lhs _ $name_rhs _f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            fn [<macro_assert_nearly_op_eq_ $name_lhs _ $name_rhs _f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            fn [<macro_assert_nearly_op_ne_ $name_lhs _ $name_rhs _f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_assert_nearly_op_eq_ $name_lhs _ $name_rhs _panaic_f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_assert_nearly_op_ne_ $name_lhs _ $name_rhs _panaic_f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            fn [<macro_debug_assert_nearly_op_eq_ $name_lhs _ $name_rhs _f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[test]
            fn [<macro_debug_assert_nearly_op_ne_ $name_lhs _ $name_rhs _f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_eq_tol right)`"#)]
            fn [<macro_debug_assert_nearly_op_eq_ $name_lhs _ $name_rhs _panic_f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
            ...
            #[cfg(debug_assertions)]
            #[should_panic(expected = r#"assertion failed: `(left nearly_ne_tol right)`"#)]
            fn [<macro_debug_assert_nearly_op_ne_ $name_lhs _ $name_rhs _panic_f64>]() {
                let a: $lhs = get_value!($name_lhs, "a", f64);
                let b: $rhs = get_value!($name_rhs, "b", f64);
